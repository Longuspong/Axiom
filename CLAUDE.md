...
| 5 | Gameplay-Systeme | ⚠️ Grid+Speed+MOB ✅, Kampfsystem+Rohschaden+Mana+Statuseffekte ✅, Trefferchance+Krit+Ausweichen ✅, **Schadenstyp Elementarschaden+Elementardiffusion+Elementar-Durchdringung+Elementare Zusatzeffekte (§5.2) ✅**, Magisch-Fernkampf-Formel final ✅, Aggro/Threat ✅, Sichtsystem ✅, Klassen ✅, Attribute ✅, Bögen+Armbrüste ✅, Einhand/Zweihand+Offhands ✅, Gravurensystem-Rahmen (§5.7) ✅, Stellar-Waffen (Stufe 7) ✅, Crafting/Resonanz-Matrix (§5.8) ✅ inkl. Drop & Herkunft, **Skilltree-Struktur-Grundlage (§5.4) ✅**; **4 Elemente stehen**, Gravuren-Katalog + Materialliste + Skilltree-Notable/Keystone-Listen ausstehend |
...
Abgeschlossen in dieser Sitzung (2026-07-09 — **Skilltree-Struktur-Grundlage + Elementarschaden-Feinschliff**, PR #20 offen, PR #19 zwischenzeitlich gemergt):
...
4. **Element-/Themen-Set-Ausrüstung designen** (§5.2) — einzige Quelle für Elementardiffusion: Werteskala, Mischverhältnis mit Rüstung/Resistenz, Drop/Craft-Herkunft (Elementare Zusatzeffekte hängen nicht mehr daran, sind bereits final designt)
5. **Skilltree-Notable-/Keystone-Listen pro Klasse ausarbeiten** — Grundstruktur steht bereits (§5.4, radialer 6-Sektoren-Baum); danach Umsetzung in Godot (Yggdrasil-Editor liegt bereit) = Start Phase 1
6. **Nebenbei:** Charakter-Sprites generieren (Pixellab.ai-Prompt unten)

> Crafting-PR (#16), Elementarschaden-PR (#17) und Schadenstyp-Audit-PR (#19) sind gemergt; Skilltree/Elementarschaden-Feinschliff-PR (#20) offen. Von den Phase-0-Kriterien sind noch **Gravuren-Katalog**, **Element-/Materialliste** und **Skilltree-Notable/Keystone-Listen** offen. Elementar-Durchdringung, Magisch-Fernkampf-Formel und Elementare Zusatzeffekte sind seit dieser Sitzung final entschieden (→ §11). Elementar-Reaktionssystem (Idee B) bewusst geparkt, nicht verworfen.  
