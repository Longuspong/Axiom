...
Abgeschlossen in dieser Sitzung (2026-07-07 — **Schadenstyp-Audit + Kriegsgeräte-Neuordnung**, PR #19 offen):
...
- **GDD → v0.19**
- Noch offen aus dem Audit: keine — alle vier besprochenen Punkte sind entschieden und eingetragen; **neu offen**: Elementar-Durchdringung (RD-Pendant), tiefere Diskussion zur Magisch-Fernkampf-Formel (vertagt)
- PR **#19** (`claude/status-update-next-steps-6rcuwz`) gepusht — wartet auf Merge durch den Nutzer
...
> Crafting-PR (#16) und Elementarschaden-PR (#17) sind gemergt; Schadenstyp-Audit-PR (#19) offen. Von den Phase-0-Kriterien sind noch **Gravuren-Katalog**, **Element-/Materialliste** und **Skilltree-Struktur** offen. Neu offen aus dem Schadenstyp-Audit (2026-07-07): **Elementar-Durchdringung** (RD-Pendant für Elementardiffusion) und die vertagte **tiefere Diskussion zur Magisch-Fernkampf-Formel** (→ §11).  
...
| Magischer Rohschaden (Reichweite) | **Entschieden (2026-07-07, §5.2):** Eine Formel (WIL+WIL) für Magie-Angriffe unabhängig von Reichweite — deckt auch Zauberstab/Energiesphäre (Reichweite 3) ab. Bewusst kein separates Fernkampf-Magisch (Zauber-Fernangriffe seltener als Schützen). Platzhalter, tiefere Diskussion folgt |
